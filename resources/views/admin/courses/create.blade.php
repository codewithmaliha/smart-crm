<x-app-layout>
    @section('title', 'Design New Curriculum')
    ...
    <div class="max-w-4xl mx-auto space-y-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center bg-white p-8 rounded-[2rem] shadow-sm border border-secondary-100 gap-6">
            <div class="flex items-center gap-5">
                ...
                <div>
                    <h2 class="text-2xl font-extrabold text-secondary-900 tracking-tight">Add Academic Course</h2>
                    <p class="text-secondary-500 font-medium">Define a new program for a partner university</p>
                </div>
            </div>
                        ...
                        <div class="col-span-full space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <select name="university_id" id="university_id" required
                                    ...
                                    <option value="">Select a University Partnership</option>
                                    @foreach($universities as $university)
                                        <option value="{{ $university->id }}">{{ $university->name }} ({{ $university->country }})</option>
                                    @endforeach
                                </select>

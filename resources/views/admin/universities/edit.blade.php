<x-app-layout>
    @section('title', 'Refine Partner Data')
    ...
    <div class="max-w-4xl mx-auto space-y-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center bg-white p-8 rounded-[2rem] shadow-sm border border-secondary-100 gap-6">
            <div class="flex items-center gap-5">
                ...
                <div>
                    <h2 class="text-2xl font-extrabold text-secondary-900 tracking-tight">Edit Institutional Data</h2>
                    <p class="text-secondary-500 font-medium">Update profile for {{ $university->name }}</p>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="col-span-full space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <input type="url" name="website" id="website" value="{{ $university->website }}"
                                    class="block w-full pl-12 pr-4 py-3.5 bg-secondary-50/50 border border-secondary-200 rounded-2xl focus:ring-4 focus:ring-primary-500/10 focus:border-primary-500 transition-all placeholder-secondary-400 text-sm font-medium"
                        ...
                        <div class="col-span-full space-y-2">
                            ...
                            <textarea name="description" id="description" rows="5"
                                ...
                                placeholder="Provide a brief overview... ">{{ $university->description }}</textarea>
                        </div>
                    </div>
